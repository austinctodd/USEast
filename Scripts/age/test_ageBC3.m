...
for j=2:482-1
  if (mask3(i,j)>0) 
    ...
    if (mask3(i-1,j)<1.0) 
      ...
      % West & North & South
      if (mask3(i,j+1)<1.0 & mask3(i,j-1)<1.0) 
      ...
      % West & South & East
      elseif (mask3(i,j-1)<1.0 & mask3(i+1,j)<1.0) 
      ...
      % West & North & East
      elseif (mask3(i,j+1)<1.0 & mask3(i,j+1)<1.0) 
