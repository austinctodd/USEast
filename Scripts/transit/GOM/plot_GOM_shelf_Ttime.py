...
plot_dir   = '/Volumes/Black_box/Data/PLOTS/USeast-age/rtime/GOM_shelf/bottom/'
...
for i in range(0,12):
  ...
  rtime=np.nanmean(input_data.variables['age_02'][stind:enind,0,:,:],axis=0)
  ...
  cn = m.contour(   xi,yi,rtime,[182.625,365.25,730.5],colors='0.5',linewidth=1.0)
  ...
  # Save figure to file
  plot_file=plot_dir+'month_'+str(i+1)+'_new.png'
