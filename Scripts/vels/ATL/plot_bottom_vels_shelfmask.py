...
input_file = '/Volumes/Black_box/Data/USeast-age/output/clim/averages/'+\
             'monthly_avg_vels.nc'
GOM_file   = '/Volumes/Black_box/Data/USeast/Data/grd/grid_ATLscope.nc'
plot_dir   = '/Volumes/Black_box/Data/PLOTS/USeast-age/vels/ATL/bottom/shelf_masked/'
...
for i in range(0,12):
  ...
  u   =np.ma.array(u   ,mask=scope[1:481,1:401])
  v   =np.ma.array(v   ,mask=scope[1:481,1:401])
  umag=np.ma.array(umag,mask=scope[1:481,1:401])
  ...
  uproj,vproj,xx,yy = m.transform_vector(u[::2,::2]*10,v[::2,::2]*10,\
