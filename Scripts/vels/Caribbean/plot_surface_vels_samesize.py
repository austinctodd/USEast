...
plot_dir   = '/Volumes/Black_box/Data/USeast-age/PLOTS/vels/Caribbean/surface/'
...
for i in range(1,12):
  ...
  # now plot.
  Q  = m.quiver(xx,yy,uproj,vproj,scale=50)
  ...
  # Save figure to file
  plot_file=plot_dir+'month_'+str(i+1)+'_unit.png'
