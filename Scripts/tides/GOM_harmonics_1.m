...
fname='/gpfs_share/rhe/actodd/USeast-tide/output/LTP/newcode_orig_TDATE/useast_his.nc';
...
save(['/gpfs_share/rhe/actodd/USeast-tide/output/LTP/newcode_orig_TDATE/',...
