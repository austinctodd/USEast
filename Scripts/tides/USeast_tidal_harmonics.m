...
fname='/gpfs_share/rhe/actodd/USeast-tide/output/LTP_OBC/oldtide_4month/useast_his.nc';
...
save(['/gpfs_share/rhe/actodd/USeast-tide/output/LTP_OBC/oldtide_4month/',...
